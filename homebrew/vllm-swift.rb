...
class VllmSwift < Formula
  ...
  bottle do
    ...
    # sha256 cellar: :any, arm64_tahoe:   "<filled by build_bottle.sh>"
    # sha256 cellar: :any, arm64_sequoia: "<filled by build_bottle.sh>"
  end
  ...
  test do
    ...
    assert_match "0.3.2", shell_output("#{bin}/vllm-swift version")
  end
end
